...
const READINGS = {
  ...
  "hairstyle-analysis": {
    inputType: "portrait",
    prompt:
      "Based on my portrait, create a hairstyle analysis graphic on a tall portrait canvas. Render multiple flattering hairstyles applied to my face arranged in a multi-row grid — for example bob, lob, layered, fringe, pixie, long-wavy, sleek-low-pony, bun — so I can see at a glance which cuts suit my face shape. Lay it out as a clean, minimal editorial spread with thin hairlines, generous whitespace, refined serif-and-sans typography, and a magazine-quality feel. Use short labels only — name each style in two or three words — and absolutely no paragraphs of theory. Keep it visual-first. Frame everything as a styling suggestion for entertainment, never a verdict on appearance. Do your best.",
    endpoint: "edits",
    imageSize: "1024x1536",
    quality: "high",
    inputFidelity: "high",

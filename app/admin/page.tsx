      ...
      try {
        ...
        projectsSnapshot.docs.forEach(doc => {
          ...
          const project: ProjectData = {
            ...
            orderDate: projectData.orderDate ? formatDate(projectData.orderDate) : undefined,
            pdfGeneratedAt: projectData.pdfGeneratedAt ? formatDate(projectData.pdfGeneratedAt) : undefined,
            thumbnailPath: projectData.thumbnailPath || projectData.firstPagePath || undefined,
            orderNumber: projectData.orderNumber || undefined,
            pageCount: projectData.pageCount || undefined,
            pdfUrl: projectData.pdfUrl || undefined,
            thumbnailUrl: projectData.thumbnailUrl || undefined,
          };

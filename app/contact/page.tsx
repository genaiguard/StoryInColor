          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <div className="rounded-lg border bg-white p-6 shadow-sm">
                ...
                {submitResult && (
                  <div className={`mb-4 p-3 rounded-md ${submitResult.success ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-red-50 text-red-700 border border-red-200'}`}>

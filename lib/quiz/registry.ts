...
const palmReadingQuiz: QuizConfig = {
  ...
  hook: {
    id: "palm-hook",
    prompt: "What pulled you toward palmistry today?",
    layout: "pill",
    options: [
      { id: "relationship", label: "A relationship moment", emoji: "💔" },
      { id: "career", label: "A career or path question", emoji: "🧭" },
      { id: "curiosity", label: "Just curiosity", emoji: "🌀" },
      { id: "experienced", label: "I read these for myself already", emoji: "🌙" },
    ],
...
const faceReadingQuiz: QuizConfig = {
  ...
  hook: {
    id: "face-hook",
    prompt: "What brings you to face reading?",
    layout: "pill",
    options: [
      { id: "self", label: "Want to understand myself better", emoji: "🪞" },
      { id: "direction", label: "Looking for direction", emoji: "🧭" },
      { id: "tradition", label: "Curious about Mian Xiang tradition", emoji: "🌟" },
      { id: "saw", label: "Saw this somewhere and got curious", emoji: "🤔" },
    ],
...
const beautyReportQuiz: QuizConfig = {
  ...
  hook: {
    id: "beauty-hook",
    prompt: "Why are you here for an honest beauty read?",
    layout: "pill",
    options: [
      { id: "score", label: "Curious how I score", emoji: "🪞" },
      { id: "tips", label: "Want grooming / styling tips", emoji: "💄" },
      { id: "photos", label: "Improving my photos / dating profile", emoji: "📸" },
      { id: "honest", label: "Friends won't tell me the truth", emoji: "🤝" },
    ],
...
const auraReadingQuiz: QuizConfig = {
  ...
  hook: {
    ...
    options: [
      ...
      { id: "energy", label: "Working on energy / chakras", emoji: "🧘" },
...
const iridologyQuiz: QuizConfig = {
  ...
  hook: {
    id: "iridology-hook",
    prompt: "What pulled you toward iris reading?",
    layout: "pill",
    options: [
      { id: "wellness", label: "Holistic wellness curiosity", emoji: "🧘" },
      { id: "eyes-show", label: "Always wondered what eyes can show", emoji: "👁" },
...
const handwritingQuiz: QuizConfig = {
  ...
  hook: {
    id: "handwriting-hook",
    prompt: "Why a graphology read?",
    layout: "pill",
    options: [
      { id: "curious", label: "Curious what my handwriting says", emoji: "✍️" },
      { id: "self", label: "Self-knowledge", emoji: "🪞" },
      { id: "gift", label: "For a friend / partner", emoji: "🎁" },
...
const styleAuditQuiz: QuizConfig = {
  ...
  hook: {
    id: "style-hook",
    prompt: "Why a style audit?",
    layout: "pill",
    options: [
      { id: "refining", label: "Refining how I dress", emoji: "🛍" },
      { id: "archetype", label: "Curious about my archetype", emoji: "🪞" },
      { id: "nail", label: "Want to nail my personal style", emoji: "🎯" },
      { id: "profile", label: "For my dating / social profile", emoji: "📸" },
    ],
  },
  identityA: sharedIdentityA,
  identityB: {
...
const hairstyleAnalysisQuiz: QuizConfig = {
  ...
  hook: {
    id: "hairstyle-hook",
    prompt: "What's behind the hair question right now?",
    layout: "pill",
    options: [
      { id: "big-change", label: "Considering a big change", emoji: "✂️" },
      { id: "rut", label: "Stuck in a rut", emoji: "🤔" },
      { id: "event", label: "Big event coming up", emoji: "💍" },
      { id: "curious", label: "Just curious what would suit me", emoji: "🪞" },
    ],
  },
  identityA: sharedIdentityA,
  identityB: {
...
const colorAnalysisQuiz: QuizConfig = {
  ...
  hook: {
    id: "color-hook",
    prompt: "Why a personal color read?",
    layout: "pill",
    options: [
      { id: "wardrobe", label: "Building a wardrobe that works", emoji: "👗" },
      { id: "undertone", label: "Want to know my undertone", emoji: "💄" },
      { id: "consult-alt", label: "Considering a House of Colour consult", emoji: "🎁" },
...
const skincareGlowQuiz: QuizConfig = {
  ...
  hook: {
    id: "skincare-hook",
    prompt: "What's bringing you to a skin read?",
    layout: "pill",
    options: [
      { id: "routine", label: "Want a routine that actually works", emoji: "✨" },
      { id: "zones", label: "Curious about my zones", emoji: "🪞" },
      { id: "glow", label: "Glow + hydration", emoji: "💧" },
      { id: "products", label: "Picking products", emoji: "🛒" },
    ],
  },
  identityA: sharedIdentityA,
  identityB: {
